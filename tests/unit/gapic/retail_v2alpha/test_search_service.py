...
from google.cloud.retail_v2alpha.services.search_service import (
...
def test_search_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_search_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceTransport.__init__"
    ) as Transport:
...
def test_search_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.retail_v2alpha.services.search_service.transports.SearchServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
