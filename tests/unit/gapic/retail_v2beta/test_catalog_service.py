...
from google.cloud.retail_v2beta.services.catalog_service import (
...
def test_catalog_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.retail_v2beta.services.catalog_service.transports.CatalogServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_catalogs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        assert path_template.validate(
            "%s/v2beta/{parent=projects/*/locations/*}/catalogs"
...
def test_update_catalog_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{catalog.name=projects/*/locations/*/catalogs/*}"
            % client.transport._host,
            args[1],
        )
...
def test_set_default_branch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{catalog=projects/*/locations/*/catalogs/*}:setDefaultBranch"
            % client.transport._host,
            args[1],
        )
...
def test_get_default_branch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{catalog=projects/*/locations/*/catalogs/*}:getDefaultBranch"
            % client.transport._host,
            args[1],
        )
...
def test_get_completion_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{name=projects/*/locations/*/catalogs/*/completionConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_update_completion_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{completion_config.name=projects/*/locations/*/catalogs/*/completionConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_get_attributes_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{name=projects/*/locations/*/catalogs/*/attributesConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_update_attributes_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        _, args, _ = req.mock_calls[0]
        assert path_template.validate(
            "%s/v2beta/{attributes_config.name=projects/*/locations/*/catalogs/*/attributesConfig}"
            % client.transport._host,
            args[1],
        )
...
def test_batch_remove_catalog_attributes_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = catalog_service.BatchRemoveCatalogAttributesResponse.pb(
            return_value
        )
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_catalog_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.retail_v2beta.services.catalog_service.transports.CatalogServiceTransport.__init__"
    ) as Transport:
