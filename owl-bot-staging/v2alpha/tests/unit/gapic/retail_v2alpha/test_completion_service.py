...
def test_complete_query_rest_required_fields(request_type=completion_service.CompleteQueryRequest):
    ...
    assert not set(unset_fields) - set(("dataset", "device_type", "enable_attribute_suggestions", "entity", "language_codes", "max_suggestions", "query", "visitor_id", ))
    jsonified_request.update(unset_fields)
...
def test_complete_query_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dataset", "deviceType", "enableAttributeSuggestions", "entity", "languageCodes", "maxSuggestions", "query", "visitorId", )) & set(("catalog", "query", )))
