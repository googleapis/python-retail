...
from google.cloud.retail_v2alpha.services.product_service import ProductServiceAsyncClient
from google.cloud.retail_v2alpha.services.product_service import ProductServiceClient
from google.cloud.retail_v2alpha.services.product_service import pagers
from google.cloud.retail_v2alpha.services.product_service import transports
...
def test_create_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2alpha/{parent=projects/*/locations/*/catalogs/*/branches/*}/products" % client.transport._host, args[1])
...
def test_get_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/branches/*/products/**}" % client.transport._host, args[1])
...
def test_list_products_rest_required_fields(request_type=product_service.ListProductsRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_products._get_unset_required_fields(jsonified_request)
    # Check that path parameters and body parameters are not mixing in.
    assert not set(unset_fields) - set(("filter", "page_size", "page_token", "read_mask", "require_total_size", ))
    jsonified_request.update(unset_fields)
...
def test_list_products_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("filter", "pageSize", "pageToken", "readMask", "requireTotalSize", )) & set(("parent", )))
...
def test_update_product_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{product.name=projects/*/locations/*/catalogs/*/branches/*/products/**}" % client.transport._host, args[1])
...
def test_set_inventory_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{inventory.name=projects/*/locations/*/catalogs/*/branches/*/products/**}:setInventory" % client.transport._host, args[1])
...
def test_add_fulfillment_places_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addFulfillmentPlaces" % client.transport._host, args[1])
...
def test_remove_fulfillment_places_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeFulfillmentPlaces" % client.transport._host, args[1])
...
def test_add_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addLocalInventories" % client.transport._host, args[1])
...
def test_remove_local_inventories_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeLocalInventories" % client.transport._host, args[1])
...
def test_product_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2alpha.services.product_service.transports.ProductServiceTransport.__init__') as Transport:
...
def test_product_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.product_service.transports.ProductServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_product_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.product_service.transports.ProductServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ProductServiceTransport()
        adc.assert_called_once()
