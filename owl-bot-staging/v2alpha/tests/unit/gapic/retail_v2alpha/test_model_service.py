...
from google.cloud.retail_v2alpha.services.model_service import ModelServiceAsyncClient
from google.cloud.retail_v2alpha.services.model_service import ModelServiceClient
from google.cloud.retail_v2alpha.services.model_service import pagers
from google.cloud.retail_v2alpha.services.model_service import transports
...
def test_model_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2alpha.services.model_service.transports.ModelServiceGrpcTransport.__init__') as grpc_transport:
...
@pytest.mark.asyncio
async def test_create_model_async(transport: str = 'grpc_asyncio', request_type=model_service.CreateModelRequest):
...
def test_create_model_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_model(
            parent='parent_value',
            model=gcr_model.Model(page_optimization_config=gcr_model.Model.PageOptimizationConfig(page_optimization_event_type='page_optimization_event_type_value')),
        )
        ...
        assert arg == mock_val
        arg = args[0].model
        mock_val = gcr_model.Model(page_optimization_config=gcr_model.Model.PageOptimizationConfig(page_optimization_event_type='page_optimization_event_type_value'))
        assert arg == mock_val
...
def test_get_model(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = model.Model(
            ...
            page_optimization_config=model.Model.PageOptimizationConfig(page_optimization_event_type='page_optimization_event_type_value'),
        )
    ...
    assert response.periodic_tuning_state == model.Model.PeriodicTuningState.PERIODIC_TUNING_DISABLED
    assert response.tuning_operation == 'tuning_operation_value'
    assert response.data_state == model.Model.DataState.DATA_OK
    assert response.filtering_option == common.RecommendationsFilteringOption.RECOMMENDATIONS_FILTERING_DISABLED
...
def test_pause_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = model.Model(
            name='name_value',
...
@pytest.mark.asyncio
async def test_pause_model_async(transport: str = 'grpc_asyncio', request_type=model_service.PauseModelRequest):
    client = ModelServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_resume_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = model.Model(
            name='name_value',
...
@pytest.mark.asyncio
async def test_resume_model_async(transport: str = 'grpc_asyncio', request_type=model_service.ResumeModelRequest):
    client = ModelServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_model(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = gcr_model.Model(
            ...
            filtering_option=common.RecommendationsFilteringOption.RECOMMENDATIONS_FILTERING_DISABLED,
            page_optimization_config=gcr_model.Model.PageOptimizationConfig(page_optimization_event_type='page_optimization_event_type_value'),
        )
    ...
    assert response.type_ == 'type__value'
    assert response.optimization_objective == 'optimization_objective_value'
    assert response.periodic_tuning_state == gcr_model.Model.PeriodicTuningState.PERIODIC_TUNING_DISABLED
    assert response.tuning_operation == 'tuning_operation_value'
...
def test_tune_model(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.tune_model),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
@pytest.mark.asyncio
async def test_tune_model_async(transport: str = 'grpc_asyncio', request_type=model_service.TuneModelRequest):
    client = ModelServiceAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_model_rest_required_fields(request_type=model_service.CreateModelRequest):
...
def test_create_model_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dryRun", )) & set(("parent", "model", )))
...
def test_create_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ModelServiceRestInterceptor, "post_create_model") as post, \
         mock.patch.object(transports.ModelServiceRestInterceptor, "pre_create_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = model_service.CreateModelRequest.pb(model_service.CreateModelRequest())
...
def test_create_model_rest_bad_request(transport: str = 'rest', request_type=model_service.CreateModelRequest):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_create_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2alpha/{parent=projects/*/locations/*/catalogs/*}/models" % client.transport._host, args[1])
...
def test_get_model_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/catalogs/sample3/models/sample4'}
    request = request_type(**request_init)
...
def test_get_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/catalogs/sample3/models/sample4'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/models/*}" % client.transport._host, args[1])
...
def test_pause_model_rest_required_fields(request_type=model_service.PauseModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).pause_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_pause_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ModelServiceRestInterceptor, "post_pause_model") as post, \
         mock.patch.object(transports.ModelServiceRestInterceptor, "pre_pause_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = model_service.PauseModelRequest.pb(model_service.PauseModelRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.pause_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_pause_model_rest_bad_request(transport: str = 'rest', request_type=model_service.PauseModelRequest):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_pause_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/models/*}:pause" % client.transport._host, args[1])
...
def test_resume_model_rest_required_fields(request_type=model_service.ResumeModelRequest):
    transport_class = transports.ModelServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).resume_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_resume_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ModelServiceRestInterceptor, "post_resume_model") as post, \
         mock.patch.object(transports.ModelServiceRestInterceptor, "pre_resume_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = model_service.ResumeModelRequest.pb(model_service.ResumeModelRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.resume_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])
...
def test_resume_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/models/*}:resume" % client.transport._host, args[1])
...
def test_update_model_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'model': {'name': 'projects/sample1/locations/sample2/catalogs/sample3/models/sample4'}}
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = gcr_model.Model.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_update_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'model': {'name': 'projects/sample1/locations/sample2/catalogs/sample3/models/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{model.name=projects/*/locations/*/catalogs/*/models/*}" % client.transport._host, args[1])
...
def test_tune_model_rest_required_fields(request_type=model_service.TuneModelRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).tune_model._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_tune_model_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.ModelServiceRestInterceptor, "post_tune_model") as post, \
         mock.patch.object(transports.ModelServiceRestInterceptor, "pre_tune_model") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.tune_model(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_tune_model_rest_bad_request(transport: str = 'rest', request_type=model_service.TuneModelRequest):
    client = ModelServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_tune_model_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/models/*}:tune" % client.transport._host, args[1])
...
def test_model_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2alpha.services.model_service.transports.ModelServiceTransport.__init__') as Transport:
...
def test_model_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.model_service.transports.ModelServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_model_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.model_service.transports.ModelServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ModelServiceTransport()
        adc.assert_called_once()
...
def test_model_path():
    ...
    catalog = "winkle"
    model = "nautilus"
    expected = "projects/{project}/locations/{location}/catalogs/{catalog}/models/{model}".format(project=project, location=location, catalog=catalog, model=model, )
