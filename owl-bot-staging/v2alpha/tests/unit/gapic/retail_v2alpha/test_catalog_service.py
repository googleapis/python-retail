...
from google.cloud.retail_v2alpha.services.catalog_service import CatalogServiceAsyncClient
from google.cloud.retail_v2alpha.services.catalog_service import CatalogServiceClient
from google.cloud.retail_v2alpha.services.catalog_service import pagers
from google.cloud.retail_v2alpha.services.catalog_service import transports
...
def test_catalog_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2alpha.services.catalog_service.transports.CatalogServiceGrpcTransport.__init__') as grpc_transport:
...
def test_list_catalogs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = catalog_service.ListCatalogsResponse.pb(return_value)
...
def test_list_catalogs_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2alpha/{parent=projects/*/locations/*}/catalogs" % client.transport._host, args[1])
...
def test_update_catalog_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = gcr_catalog.Catalog.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_update_catalog_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{catalog.name=projects/*/locations/*/catalogs/*}" % client.transport._host, args[1])
...
def test_set_default_branch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{catalog=projects/*/locations/*/catalogs/*}:setDefaultBranch" % client.transport._host, args[1])
...
def test_get_default_branch_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = catalog_service.GetDefaultBranchResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_default_branch_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{catalog=projects/*/locations/*/catalogs/*}:getDefaultBranch" % client.transport._host, args[1])
...
def test_get_completion_config_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = catalog.CompletionConfig.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_completion_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/completionConfig}" % client.transport._host, args[1])
...
def test_update_completion_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{completion_config.name=projects/*/locations/*/catalogs/*/completionConfig}" % client.transport._host, args[1])
...
def test_get_attributes_config_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = catalog.AttributesConfig.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_attributes_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/attributesConfig}" % client.transport._host, args[1])
...
def test_update_attributes_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{attributes_config.name=projects/*/locations/*/catalogs/*/attributesConfig}" % client.transport._host, args[1])
...
def test_batch_remove_catalog_attributes_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = catalog_service.BatchRemoveCatalogAttributesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_catalog_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2alpha.services.catalog_service.transports.CatalogServiceTransport.__init__') as Transport:
...
def test_catalog_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.catalog_service.transports.CatalogServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_catalog_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.catalog_service.transports.CatalogServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CatalogServiceTransport()
        adc.assert_called_once()
