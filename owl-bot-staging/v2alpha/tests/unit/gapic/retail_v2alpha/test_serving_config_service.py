...
from google.cloud.retail_v2alpha.services.serving_config_service import ServingConfigServiceAsyncClient
from google.cloud.retail_v2alpha.services.serving_config_service import ServingConfigServiceClient
from google.cloud.retail_v2alpha.services.serving_config_service import pagers
from google.cloud.retail_v2alpha.services.serving_config_service import transports
...
def test_serving_config_service_client_client_options_from_dict():
    with mock.patch('google.cloud.retail_v2alpha.services.serving_config_service.transports.ServingConfigServiceGrpcTransport.__init__') as grpc_transport:
...
def test_create_serving_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2alpha/{parent=projects/*/locations/*/catalogs/*}/servingConfigs" % client.transport._host, args[1])
...
def test_delete_serving_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{name=projects/*/locations/*/catalogs/*/servingConfigs/*}" % client.transport._host, args[1])
...
def test_update_serving_config_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{serving_config.name=projects/*/locations/*/catalogs/*/servingConfigs/*}" % client.transport._host, args[1])
...
def test_list_serving_configs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = serving_config_service.ListServingConfigsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_add_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{serving_config=projects/*/locations/*/catalogs/*/servingConfigs/*}:addControl" % client.transport._host, args[1])
...
def test_remove_control_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{serving_config=projects/*/locations/*/catalogs/*/servingConfigs/*}:removeControl" % client.transport._host, args[1])
...
def test_serving_config_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2alpha.services.serving_config_service.transports.ServingConfigServiceTransport.__init__') as Transport:
...
def test_serving_config_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2alpha.services.serving_config_service.transports.ServingConfigServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_serving_config_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2alpha.services.serving_config_service.transports.ServingConfigServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ServingConfigServiceTransport()
        adc.assert_called_once()
