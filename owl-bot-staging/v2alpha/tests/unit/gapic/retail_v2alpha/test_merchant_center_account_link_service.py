...
from google.cloud.retail_v2alpha.services.merchant_center_account_link_service import MerchantCenterAccountLinkServiceAsyncClient
from google.cloud.retail_v2alpha.services.merchant_center_account_link_service import MerchantCenterAccountLinkServiceClient
from google.cloud.retail_v2alpha.services.merchant_center_account_link_service import transports
...
@pytest.mark.parametrize("client_class,transport_name", [
    (MerchantCenterAccountLinkServiceClient, "grpc"),
    (MerchantCenterAccountLinkServiceAsyncClient, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class", [
    MerchantCenterAccountLinkServiceClient, MerchantCenterAccountLinkServiceAsyncClient
])
@mock.patch.object(MerchantCenterAccountLinkServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MerchantCenterAccountLinkServiceClient))
@mock.patch.object(MerchantCenterAccountLinkServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(MerchantCenterAccountLinkServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (MerchantCenterAccountLinkServiceAsyncClient, transports.MerchantCenterAccountLinkServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
...
def test_list_merchant_center_account_links(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.list_merchant_center_account_links),
            '__call__') as call:
...
async def test_list_merchant_center_account_links_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.list_merchant_center_account_links(
            merchant_center_account_link_service.ListMerchantCenterAccountLinksRequest(),
            parent='parent_value',
        )
...
def test_create_merchant_center_account_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_merchant_center_account_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_delete_merchant_center_account_link(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_merchant_center_account_link),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_delete_merchant_center_account_link_flattened_error_async():
    ...
    # fields is an error.
    with pytest.raises(ValueError):
        await client.delete_merchant_center_account_link(
            merchant_center_account_link_service.DeleteMerchantCenterAccountLinkRequest(),
            name='name_value',
        )
...
def test_list_merchant_center_account_links_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        pb_return_value = merchant_center_account_link_service.ListMerchantCenterAccountLinksResponse.pb(return_value)
...
def test_list_merchant_center_account_links_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "post_list_merchant_center_account_links") as post, \
         mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "pre_list_merchant_center_account_links") as pre:
...
def test_create_merchant_center_account_link_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("parent", )) & set(("parent", "merchantCenterAccountLink", )))
...
def test_create_merchant_center_account_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "post_create_merchant_center_account_link") as post, \
         mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "pre_create_merchant_center_account_link") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_merchant_center_account_link_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'merchant_center_account_link': {'name': 'projects/sample1/locations/sample2/catalogs/sample3/merchantCenterAccountLinks/sample4'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2alpha/{merchant_center_account_link.name=projects/*/locations/*/catalogs/*/merchantCenterAccountLinks/*}" % client.transport._host, args[1])
...
def test_delete_merchant_center_account_link_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.MerchantCenterAccountLinkServiceRestInterceptor, "pre_delete_merchant_center_account_link") as pre:
        pre.assert_not_called()
...
def test_transport_get_channel():
    ...
    transport = transports.MerchantCenterAccountLinkServiceGrpcAsyncIOTransport(
        credentials=ga_credentials.AnonymousCredentials(),
    )
    channel = transport.grpc_channel
    assert channel
...
def test_transport_kind(transport_name):
    transport = MerchantCenterAccountLinkServiceClient.get_transport_class(transport_name)(
        credentials=ga_credentials.AnonymousCredentials(),
    )
...
def test_merchant_center_account_link_service_client_transport_session_collision(transport_name):
    ...
    client2 = MerchantCenterAccountLinkServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
