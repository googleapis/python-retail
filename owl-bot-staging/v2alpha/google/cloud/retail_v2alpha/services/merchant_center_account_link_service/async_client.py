...
class MerchantCenterAccountLinkServiceAsyncClient:
    ...
    get_transport_class = functools.partial(type(MerchantCenterAccountLinkServiceClient).get_transport_class, type(MerchantCenterAccountLinkServiceClient))

    def __init__(self, *,
            credentials: Optional[ga_credentials.Credentials] = None,
            transport: Union[str, MerchantCenterAccountLinkServiceTransport] = "grpc_asyncio",
    ...
    async def list_merchant_center_account_links(self,
    ...
    async def create_merchant_center_account_link(self,
    ...
    async def delete_merchant_center_account_link(self,
