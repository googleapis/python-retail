...
from .transports.base import MerchantCenterAccountLinkServiceTransport, DEFAULT_CLIENT_INFO
...
class MerchantCenterAccountLinkServiceClient(metaclass=MerchantCenterAccountLinkServiceClientMeta):
    ...
    @staticmethod
    def merchant_center_account_link_path(project: str,location: str,catalog: str,merchant_center_account_link: str,) -> str:
        """Returns a fully-qualified merchant_center_account_link string."""
        return "projects/{project}/locations/{location}/catalogs/{catalog}/merchantCenterAccountLinks/{merchant_center_account_link}".format(project=project, location=location, catalog=catalog, merchant_center_account_link=merchant_center_account_link, )
    ...
    def parse_merchant_center_account_link_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/catalogs/(?P<catalog>.+?)/merchantCenterAccountLinks/(?P<merchant_center_account_link>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, MerchantCenterAccountLinkServiceTransport]] = None,
    ...
    def list_merchant_center_account_links(self,
    ...
    def create_merchant_center_account_link(self,
        ...
        metadata = tuple(metadata) + (
            gapic_v1.routing_header.to_grpc_metadata((
                ("merchant_center_account_link.name", request.merchant_center_account_link.name),
            )),
        )
    ...
    def delete_merchant_center_account_link(self,
