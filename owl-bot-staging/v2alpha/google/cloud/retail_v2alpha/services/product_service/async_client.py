...
from google.cloud.retail_v2alpha.types import promotion
...
class ProductServiceAsyncClient:
    ...
    async def create_product(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.CreateProductRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            product (:class:`google.cloud.retail_v2alpha.types.Product`):
                Required. The
                [Product][google.cloud.retail.v2alpha.Product] to
                create.
            ...
            product_id (:class:`str`):
                ...
                [Product][google.cloud.retail.v2alpha.Product], which
    ...
    async def get_product(self,
        ...
        .. code-block:: python
            ...
            async def sample_get_product():
                ...
                # Initialize request argument(s)
                request = retail_v2alpha.GetProductRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.GetProductRequest, dict]]):
                The request object. Request message for
            ...
            name (:class:`str`):
                ...
                If the requested
                [Product][google.cloud.retail.v2alpha.Product] does not
    ...
    async def list_products(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.ListProductsRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                [Product][google.cloud.retail.v2alpha.Product]s under
    ...
    async def update_product(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.UpdateProductRequest, dict]]):
                The request object. Request message for
            ...
            update_mask (:class:`google.protobuf.field_mask_pb2.FieldMask`):
                ...
                [Product][google.cloud.retail.v2alpha.Product] to
                update. The immutable and output only fields are NOT
                supported. If not set, all supported fields (the fields
                that are neither immutable nor output only) are updated.
    ...
    async def delete_product(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.DeleteProductRequest, dict]]):
                The request object. Request message for
            ...
            name (:class:`str`):
                ...
                [Product][google.cloud.retail.v2alpha.Product] member
                nor a
                [Product.Type.PRIMARY][google.cloud.retail.v2alpha.Product.Type.PRIMARY]
                [Product][google.cloud.retail.v2alpha.Product] with more
                than one
                [variants][google.cloud.retail.v2alpha.Product.Type.VARIANT].
    ...
    async def purge_products(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.PurgeProductsRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2alpha.types.PurgeProductsResponse` Response of the PurgeProductsRequest. If the long running operation is
    ...
    async def import_products(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.ImportProductsRequest, dict]]):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2alpha.types.ImportProductsResponse` Response of the
...
initial=0.1,maximum=300.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def set_inventory(self,
        ...
        .. code-block:: python
            ...
            async def sample_set_inventory():
                ...
                request = retail_v2alpha.SetInventoryRequest(
                    inventory=inventory,
                )
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.SetInventoryRequest, dict]]):
                The request object. Request message for
                [ProductService.SetInventory][google.cloud.retail.v2alpha.ProductService.SetInventory]
                method.
            inventory (:class:`google.cloud.retail_v2alpha.types.Product`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2alpha.types.SetInventoryResponse` Response of the SetInventoryRequest. Currently empty because
    ...
    async def add_fulfillment_places(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.AddFulfillmentPlacesRequest, dict]]):
                The request object. Request message for
                [ProductService.AddFulfillmentPlaces][google.cloud.retail.v2alpha.ProductService.AddFulfillmentPlaces]
                method.
            product (:class:`str`):
    ...
    async def remove_fulfillment_places(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.RemoveFulfillmentPlacesRequest, dict]]):
                The request object. Request message for
                [ProductService.RemoveFulfillmentPlaces][google.cloud.retail.v2alpha.ProductService.RemoveFulfillmentPlaces]
                method.
            product (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2alpha.types.RemoveFulfillmentPlacesResponse` Response of the RemoveFulfillmentPlacesRequest. Currently empty because there
    ...
    async def add_local_inventories(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.AddLocalInventoriesRequest, dict]]):
                The request object. Request message for
                [ProductService.AddLocalInventories][google.cloud.retail.v2alpha.ProductService.AddLocalInventories]
                method.
            product (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2alpha.types.AddLocalInventoriesResponse` Response of the
                   [ProductService.AddLocalInventories][google.cloud.retail.v2alpha.ProductService.AddLocalInventories]
    ...
    async def remove_local_inventories(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2alpha.types.RemoveLocalInventoriesRequest, dict]]):
                The request object. Request message for
                [ProductService.RemoveLocalInventories][google.cloud.retail.v2alpha.ProductService.RemoveLocalInventories]
                method.
            product (:class:`str`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                The result type for the operation will be :class:`google.cloud.retail_v2alpha.types.RemoveLocalInventoriesResponse` Response of the
                   [ProductService.RemoveLocalInventories][google.cloud.retail.v2alpha.ProductService.RemoveLocalInventories]
                   API. Currently empty because there is no meaningful
                   response populated from the
                   [ProductService.RemoveLocalInventories][google.cloud.retail.v2alpha.ProductService.RemoveLocalInventories]
