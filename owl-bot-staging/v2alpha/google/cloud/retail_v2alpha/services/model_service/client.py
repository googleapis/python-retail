...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
    ...
    @staticmethod
    def model_path(project: str,location: str,catalog: str,model: str,) -> str:
        """Returns a fully-qualified model string."""
        return "projects/{project}/locations/{location}/catalogs/{catalog}/models/{model}".format(project=project, location=location, catalog=catalog, model=model, )
    ...
    def get_model(self,
        ...
        .. code-block:: python
            ...
            def sample_get_model():
                ...
                # Initialize request argument(s)
                request = retail_v2alpha.GetModelRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.retail_v2alpha.types.GetModelRequest, dict]):
                The request object. Request for getting a model.
            name (str):
                Required. The resource name of the
                [Model][google.cloud.retail.v2alpha.Model] to get.
                Format:
