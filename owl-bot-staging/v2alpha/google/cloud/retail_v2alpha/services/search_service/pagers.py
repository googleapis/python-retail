...
class SearchPager:
    ...
    :class:`google.cloud.retail_v2alpha.types.SearchResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2alpha.types.SearchResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.retail_v2alpha.types.SearchRequest):
                The initial request object.
            response (google.cloud.retail_v2alpha.types.SearchResponse):
