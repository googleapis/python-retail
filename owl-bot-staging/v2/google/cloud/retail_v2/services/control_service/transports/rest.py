...
class ControlServiceRestTransport(ControlServiceTransport):
    ...
    class _CreateControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*/catalogs/*}/controls',
                'body': 'control',
            },
            ]
    ...
    class _DeleteControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/locations/*/catalogs/*/controls/*}',
            },
            ]
    ...
    class _UpdateControl(ControlServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v2/{control.name=projects/*/locations/*/catalogs/*/controls/*}',
                'body': 'control',
            },
            ]
