...
class ControlServiceAsyncClient:
    ...
    async def create_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.CreateControlRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            control (:class:`google.cloud.retail_v2.types.Control`):
    ...
    async def delete_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.DeleteControlRequest, dict]]):
    ...
    async def update_control(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.UpdateControlRequest, dict]]):
    ...
    async def list_controls(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.ListControlsRequest, dict]]):
