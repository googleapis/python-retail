...
class CompletionServiceAsyncClient:
    ...
    async def complete_query(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.CompleteQueryRequest, dict]]):
    ...
    async def import_completion_data(self,
        ...
        Args:
            request (Optional[Union[google.cloud.retail_v2.types.ImportCompletionDataRequest, dict]]):
