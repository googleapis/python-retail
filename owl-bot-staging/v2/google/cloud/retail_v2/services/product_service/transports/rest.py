...
class ProductServiceRestTransport(ProductServiceTransport):
    ...
    class _AddFulfillmentPlaces(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addFulfillmentPlaces',
                'body': '*',
            },
            ]
    ...
    class _AddLocalInventories(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:addLocalInventories',
                'body': '*',
            },
            ]
    ...
    class _CreateProduct(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*/catalogs/*/branches/*}/products',
                'body': 'product',
            },
            ]
    ...
    class _DeleteProduct(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/locations/*/catalogs/*/branches/*/products/**}',
            },
            ]
    ...
    class _ImportProducts(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*/catalogs/*/branches/*}/products:import',
                'body': '*',
            },
            ]
    ...
    class _RemoveFulfillmentPlaces(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{product=projects/*/locations/*/catalogs/*/branches/*/products/**}:removeFulfillmentPlaces',
                'body': '*',
            },
            ]
    ...
    class _SetInventory(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{inventory.name=projects/*/locations/*/catalogs/*/branches/*/products/**}:setInventory',
                'body': '*',
            },
            ]
    ...
    class _UpdateProduct(ProductServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v2/{product.name=projects/*/locations/*/catalogs/*/branches/*/products/**}',
                'body': 'product',
            },
            ]
