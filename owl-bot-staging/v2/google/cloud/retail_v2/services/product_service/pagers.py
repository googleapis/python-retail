...
class ListProductsPager:
    ...
    :class:`google.cloud.retail_v2.types.ListProductsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2.types.ListProductsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            response (google.cloud.retail_v2.types.ListProductsResponse):
