...
class ModelServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    """
    def pre_create_model(self, request: model_service.CreateModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[model_service.CreateModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_models(self, response: model_service.ListModelsResponse) -> model_service.ListModelsResponse:
        ...
        """
        return response
    def pre_pause_model(self, request: model_service.PauseModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[model_service.PauseModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_pause_model(self, response: model.Model) -> model.Model:
        ...
        """
        return response
    def pre_resume_model(self, request: model_service.ResumeModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[model_service.ResumeModelRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_resume_model(self, response: model.Model) -> model.Model:
        ...
        """
        return response
    def pre_tune_model(self, request: model_service.TuneModelRequest, metadata: Sequence[Tuple[str, str]]) -> Tuple[model_service.TuneModelRequest, Sequence[Tuple[str, str]]]:
...
class ModelServiceRestTransport(ModelServiceTransport):
    ...
    class _CreateModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{parent=projects/*/locations/*/catalogs/*}/models',
                'body': 'model',
            },
            ]
    ...
    class _DeleteModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'delete',
                'uri': '/v2/{name=projects/*/locations/*/catalogs/*/models/*}',
            },
            ]
    ...
    class _GetModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            Returns:
                ...
                parameters of a [Model][google.cloud.retail.v2.Model]. A
                [Model][google.cloud.retail.v2.Model] can be associated
                with a
    ...
    class _PauseModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=projects/*/locations/*/catalogs/*/models/*}:pause',
                'body': '*',
            },
            ]
    ...
    class _ResumeModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=projects/*/locations/*/catalogs/*/models/*}:resume',
                'body': '*',
            },
            ]
    ...
    class _TuneModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'post',
                'uri': '/v2/{name=projects/*/locations/*/catalogs/*/models/*}:tune',
                'body': '*',
            },
            ]
    ...
    class _UpdateModel(ModelServiceRestStub):
        ...
        def __call__(self,
            ...
            http_options: List[Dict[str, str]] = [{
                'method': 'patch',
                'uri': '/v2/{model.name=projects/*/locations/*/catalogs/*/models/*}',
                'body': 'model',
            },
            ]
