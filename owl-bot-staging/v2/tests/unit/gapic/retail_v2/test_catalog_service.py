...
def test_set_default_branch(transport: str = 'grpc', request_type=catalog_service.SetDefaultBranchRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_set_default_branch_from_dict():
    test_set_default_branch(request_type=dict)
...
def test_get_default_branch(transport: str = 'grpc', request_type=catalog_service.GetDefaultBranchRequest):
    client = CatalogServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_default_branch_from_dict():
    test_get_default_branch(request_type=dict)
