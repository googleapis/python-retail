...
from google.cloud.retail_v2.services.control_service import ControlServiceAsyncClient
from google.cloud.retail_v2.services.control_service import ControlServiceClient
from google.cloud.retail_v2.services.control_service import pagers
from google.cloud.retail_v2.services.control_service import transports
...
def test_create_control_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_control(
            parent='parent_value',
            control=gcr_control.Control(rule=common.Rule(boost_action=common.Rule.BoostAction(boost=0.551))),
