...
from google.cloud.retail_v2beta.services.completion_service import CompletionServiceAsyncClient
from google.cloud.retail_v2beta.services.completion_service import CompletionServiceClient
from google.cloud.retail_v2beta.services.completion_service import transports
...
@pytest.mark.parametrize("client_class", [
    CompletionServiceClient, CompletionServiceAsyncClient
])
@mock.patch.object(CompletionServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CompletionServiceClient))
@mock.patch.object(CompletionServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CompletionServiceAsyncClient))
...
def test_complete_query_rest_required_fields(request_type=completion_service.CompleteQueryRequest):
    ...
    assert not set(unset_fields) - set(("dataset", "device_type", "entity", "language_codes", "max_suggestions", "query", "visitor_id", ))
    jsonified_request.update(unset_fields)
...
def test_complete_query_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("dataset", "deviceType", "entity", "languageCodes", "maxSuggestions", "query", "visitorId", )) & set(("catalog", "query", )))
...
def test_complete_query_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CompletionServiceRestInterceptor, "post_complete_query") as post, \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_complete_query") as pre:
        ...
        req.return_value._content = completion_service.CompleteQueryResponse.to_json(completion_service.CompleteQueryResponse())
        ...
        client.complete_query(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_complete_query_rest_bad_request(transport: str = 'rest', request_type=completion_service.CompleteQueryRequest):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_completion_data_rest(request_type):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
...
def test_import_completion_data_rest_required_fields(request_type=import_config.ImportCompletionDataRequest):
    transport_class = transports.CompletionServiceRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).import_completion_data._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_import_completion_data_rest_unset_required_fields():
    ...
    unset_fields = transport.import_completion_data._get_unset_required_fields({})
    assert set(unset_fields) == (set(()) & set(("parent", "inputConfig", )))


@pytest.mark.parametrize("null_interceptor", [True, False])
def test_import_completion_data_rest_interceptors(null_interceptor):
    transport = transports.CompletionServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CompletionServiceRestInterceptor(),
        )
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CompletionServiceRestInterceptor, "post_import_completion_data") as post, \
         mock.patch.object(transports.CompletionServiceRestInterceptor, "pre_import_completion_data") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = import_config.ImportCompletionDataRequest.pb(import_config.ImportCompletionDataRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        client.import_completion_data(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_import_completion_data_rest_bad_request(transport: str = 'rest', request_type=import_config.ImportCompletionDataRequest):
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_import_completion_data_rest_error():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest'
    )
...
def test_completion_service_base_transport():
    ...
    with mock.patch('google.cloud.retail_v2beta.services.completion_service.transports.CompletionServiceTransport.__init__') as Transport:
...
def test_completion_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.retail_v2beta.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_completion_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.retail_v2beta.services.completion_service.transports.CompletionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.CompletionServiceTransport()
        adc.assert_called_once()
...
def test_completion_service_rest_lro_client():
    client = CompletionServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport='rest',
    )
...
def test_completion_service_client_transport_session_collision(transport_name):
    creds1 = ga_credentials.AnonymousCredentials()
    creds2 = ga_credentials.AnonymousCredentials()
    client1 = CompletionServiceClient(
        credentials=creds1,
        transport=transport_name,
    )
    client2 = CompletionServiceClient(
        credentials=creds2,
        transport=transport_name,
    )
    ...
    session1 = client1.transport.import_completion_data._session
    session2 = client2.transport.import_completion_data._session
    assert session1 != session2
