...
class ListModelsPager:
    ...
    :class:`google.cloud.retail_v2beta.types.ListModelsResponse` object, and
    ...
    All the usual :class:`google.cloud.retail_v2beta.types.ListModelsResponse`
    ...
    def __init__(self,
        ...
        Args:
            ...
            request (google.cloud.retail_v2beta.types.ListModelsRequest):
                The initial request object.
            response (google.cloud.retail_v2beta.types.ListModelsResponse):
