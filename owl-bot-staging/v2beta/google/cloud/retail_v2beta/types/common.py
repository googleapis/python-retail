...
class Condition(proto.Message):
    ...
    Attributes:
        query_terms (Sequence[google.cloud.retail_v2beta.types.Condition.QueryTerm]):
        ...
        active_time_range (Sequence[google.cloud.retail_v2beta.types.Condition.TimeRange]):
